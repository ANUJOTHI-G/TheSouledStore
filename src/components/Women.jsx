...
const initialWomenProducts = [
  { id: 1, name: 'Tops', price: 29.99, description: 'Description for women product 1', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1713781292_7594978.jpg?format=webp&w=480&dpr=1.3' },
  { id: 2, name: 'Jumpsuit', price: 49.99, description: 'Description for women product 2', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1721455961_1149734.jpg?format=webp&w=1080&dpr=1.3' },
  { id: 3, name: 'T-shirt', price: 39.99, description: 'Description for women product 3', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1717149388_5569831.jpg?format=webp&w=768&dpr=1.3' },
  // { id: 4, name: 'Women Product 4', price: 59.99, description: 'Description for women product 4', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1714462523_6662696.jpg?format=webp&w=768&dpr=1.3' },
  // { id: 5, name: 'Women Product 5', price: 44.99, description: 'Description for women product 5', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1710520262_9523828.jpg?format=webp&w=768&dpr=1.3' },
  // { id: 6, name: 'Women Product 6', price: 24.99, description: 'Description for women product 6', image: 'https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1719638723_7835947.jpg?format=webp&w=1080&dpr=1.3' },
];
...
const Women = () => {
  ...
  return (
    <div>
      <Box className="jump">
        <img src="https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/category/catban-520240727163512.jpg?format=webp&w=1500&dpr=0.8" alt="Slay The Day - All New Tops" className="banner-image" />
      </Box>
    <Container>
      <Typography variant="h4" align="center" gutterBottom>
        Slay The Day!
